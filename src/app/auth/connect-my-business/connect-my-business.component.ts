...
@Component({
  selector: 'app-connect-my-business',
  templateUrl: './connect-my-business.component.html',
...
export class ConnectMyBusinessComponent implements OnInit {
  ...
  name: any;
  constructor(private fb: FormBuilder, private _authService: AuthService, private router: Router, private _sharedService: SharedService,private _toastrService: ToastrService,) { }
  ngOnInit() {
    ...
    this.router.events.subscribe(event => {
      if (event instanceof NavigationStart) {
        if (event.url === '/auth/sign-up' && event.navigationTrigger === 'popstate' && !confirmationDisplayed) {
  ...
  console.log('Address',result.business_status);
